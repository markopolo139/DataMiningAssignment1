---
title: "Titanic"
author: ' Mateusz Bernart, Patryk Janiak, Patrick Molina, Marek Seget, Chihab Zitouni'
date: "2024-04-20"
output:
...
```{r "Classifiers after preprocessing", fig.align="center", message=F, echo=F, fig.height=4, fig.width=8}
scores <- data.frame(
    score_before = c(64.35, 91.36, 80.36),
    score = c(90.94, 85.20, 90.94),
    classifier = c("SVC", "LRC", "RFC"))
